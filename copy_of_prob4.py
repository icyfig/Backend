   ...
   while(positions_determined != B):
      ...
      if((query_no+1) %10 == 1 and (query_no+1) != 1):#It is a quantum query
         ...
         if(flip_pair_forward_index == -1):
            print(1)#Asking for a random, already known position
         else:
            print(flip_pair_forward_index+1)
         ...
         if(old_rev == -1):
            ...
            print(rev_pair_forward_index + 1)
